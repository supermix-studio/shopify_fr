(function (window, k) {
    if (!window.AppstleIncluded && (!urlIsProductPage() || 'V1' === 'V2')) {
      ...
      appstleLoadScript("https://cdn.shopify.com/s/files/1/2530/6030/t/66/assets/appstle-subscription-v2.js?v=1674138241");
      ...
      RS.Config = {
        ...
        "shop": "kavee-c-c-cages.myshopify.com",
...
<div class="appstle_span_wrapper">
 ...
 {{#showSecondFormattedDiscountText}}<span class="appstle_lowercase appstle_sellingPlan_price appstle_discount_block">&nbsp;({{{secondFormattedDiscountText}}})</span>{{/showSecondFormattedDiscountText}}
<span class="appstle_formattedPrepaidPerDeliveryPriceText">&nbsp;({{{formattedPrepaidPerDeliveryPriceText}}})</span>
        </div>
